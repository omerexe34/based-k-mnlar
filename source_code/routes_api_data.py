...
Eger kullanici 'sifremi unuttum, e-posta eklememistim' veya benzeri bir sey soylerse:
1. Kullanicidan SADECE 4 BILGI ISTE:
   - Kullanici Adi
   - Gercek Adi ve Soyadi
   - Hangi sehirde oldugu
   - Hesabina profil resmi ekleyip eklemedigi
2. Kullanici bu dort soruyu cevapladiginda, kullanicinin verdigi gercek bilgilerle (ISIM yerine Mert Yilmaz gibi) SADECE SU JSON'i gonder:
